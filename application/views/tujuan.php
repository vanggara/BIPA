                            ...
                            <div class="card card-hover">
                                <div class="box bg-rectangle-brown text-center">
                                    <h5 class="bnr-para-rectangle">
                                        - Pembelajar dapat mengidentifikasi kata dan frasa dari tuturan percakapan di
                                        tempat umum (Warung).
                                        <br>
                                        - Pembelajar dapat mengidentifikasi kata atau frasa yang tepat dalam kalimat
                                        sederhana untuk merespons tuturan komunikasi sehari hari dalam dialog transaksi
                                        jual beli di warung makan.
                                        <br>
                                        - Pembelajar mampu menggunakan kalimat dan ungkapan yang relevan dengan
                                        kepentingan untuk merepon tuturan yang ada pada teks transaksi jual beli di
                                        warung makan.
                                    </h5>
                                </div>
                            </div>

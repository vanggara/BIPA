            ...
            <section class="wm">
                ...
                <div class="container wow fadeInUp delay-05s">
                    <div class="col-md-12 text-center section-padding">
                        <h2 class="bnr-sub-title">TEBAK KATA SMART BIPA</h2>
                    </div>
                    <!-- Column -->
                    <form method="post" action="<?php echo base_url('CTebak/action_nama_tebak_kata/0')?>">
                        <div class="row">
                            <!-- Column -->
                            <div class="col-md-12">
                                <div class="card card-hover">
                                    <div class="box bg-rectangle-brown text-center">
                                        <h4 class="bnr-para">
                                            <strong>Isi Nama Lengkap dan Asal Negara Kamu</strong></h4>
                                        <hr>

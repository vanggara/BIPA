            ...
            <section class="wm">
                ...
                <div class="container wow fadeInUp delay-05s">
                    <div class="col-md-12 text-center section-padding">
                        ...
                        <h3 class="bnr-para">Universitas Brawijaya</h3>
                    </div>
                    <!-- Column -->
                    <iframe class="h_iframe" type="text/html"
                        src="https://www.youtube.com/embed?listType=playlist&list=PL_Dr619uIPNvbdfORCTJJXUa2zlZ1dwrX"
